...
export const jsHighlight = styleTags({
  ...
  "let var const using function hook component class extends": t.definitionKeyword,
  ...
  "FunctionDeclaration/ComponentDeclaration/VariableDefinition": t.function(t.definition(t.variableName)),
